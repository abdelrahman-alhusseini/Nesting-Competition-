  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: <BoxShadow>[
          BoxShadow(color: const Color(0xFF368CFF).withValues(alpha: 0.8), blurRadius: 35),
        ],
      ),
      child: const Column(
        mainAxisAlignment: MainAxisAlignment.center,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: <Color>[color.withValues(alpha: 0.72), const Color(0xFF16062E)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(26),
        border: Border.all(color: color.withValues(alpha: 0.95), width: 6),
        boxShadow: <BoxShadow>[
          BoxShadow(color: color.withValues(alpha: 0.8), blurRadius: 38),
        ],
      ),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
