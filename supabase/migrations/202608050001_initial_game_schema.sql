...
create table public.game_settings (
  ...
  gamble_plus_four_chance numeric(5,4) not null default 0.50 check (gamble_plus_four_chance between 0 and 1),
  gamble_minus_six_chance numeric(5,4) not null default 0.50 check (gamble_minus_six_chance between 0 and 1),
  updated_at timestamptz not null default now(),
